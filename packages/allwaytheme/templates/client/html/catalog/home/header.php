...
<?php if( isset( $this->homeTree ) ) : ?>
	...
	<title><?= $enc->html( strip_tags( $this->homeTree->getName() ) ) ?> | <?= $enc->html( $this->get( 'contextSiteLabel', 'Allway' ) ) ?></title>

	<meta property="og:type" content="website">
	<meta property="og:site_name" content="<?= $enc->attr( $this->get( 'contextSiteLabel', 'Allway' ) ) ?>">
...
<?php else : ?>
	...
	<title><?= $enc->html( $this->get( 'contextSiteLabel', 'Allway' ) ) ?></title>
...
<meta name="application-name" content="Allway">
